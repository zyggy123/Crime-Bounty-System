...
-- Drops and recreates all entries on every execution.
-- ============================================================

-- NPC: Bounty Hunters (used by the Lua script)
...
-- NPC: Bounty Board (gossip NPC that shows wanted players)
DELETE FROM `creature_template` WHERE `entry` = 900013;
DELETE FROM `creature_template_model` WHERE `CreatureID` = 900013;

INSERT INTO `creature_template` (`entry`, `name`, `subname`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `speed_walk`, `speed_run`, `rank`, `unit_class`, `unit_flags`, `AIName`, `ScriptName`)
VALUES (900013, 'Bounty Board', 'Wanted Poster', 1, 1, 35, 1, 1.0, 1.14286, 0, 1, 0, '', '');

INSERT INTO `creature_template_model` (`CreatureID`, `Idx`, `CreatureDisplayID`, `DisplayScale`, `Probability`)
VALUES (900013, 0, 647, 1.0, 1);

-- Table: wanted player data (auto-created by Lua script)
-- This is here for reference and manual setup.
-- The Lua script creates it via WorldDBExecute on first run.
/*
